        ...
        <div class="page-heading mb-4">
            <div class="row align-items-center gy-2">
                <div class="col-12 col-sm-6">
                    <h3 class="m-0 fw-bold fs-4" style="color: #0f172a;">
                        <i class="fas fa-user-plus me-2" style="color: #64748b;"></i>เพิ่มข้อมูลอาจารย์และผู้ดูแล
                    </h3>
        ...
        <div class="page-content">
            <form action="{{ url('admin/create') }}" method="POST" enctype="multipart/form-data" id="adminAddForm">
                ...
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4" style="border: 1px solid #e2e8f0 !important;">
                            ...
                            <div class="col-12 col-lg-3 text-center border-end-lg pe-lg-4">
                                <div class="mb-3">
                                    ...
                                    <div class="position-relative d-inline-block">
                                        <div class="rounded-circle overflow-hidden bg-white d-flex align-items-center justify-content-center mx-auto"
                                             style="width: 140px; height: 140px; border: 2px solid #e2e8f0;" id="avatarContainer">
                                        ...
                                        <label for="profile_picture"
                                               class="btn btn-sm btn-primary rounded-circle position-absolute bottom-0 end-0 p-2 shadow-sm"
                    ...
                    <div class="card-footer bg-white px-4 py-3 d-flex flex-wrap justify-content-end gap-2" style="border-top: 1px solid #f1f5f9 !important;">
